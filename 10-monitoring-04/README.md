...
```
arsen@aurora:/data/10-ansible/10-monitoring-04-elk/help$ docker compose ps
NAME                COMMAND                  SERVICE             STATUS              PORTS
es-hot              "/bin/tini -- /usr/l…"   es-hot              running             0.0.0.0:9200->9200/tcp, :::9200->9200/tcp, 9300/tcp
es-warm             "/bin/tini -- /usr/l…"   es-warm             running             9200/tcp, 9300/tcp
filebeat            "/usr/bin/tini -- /u…"   filebeat            exited (1)          
